...
class My_Calendar_Mini_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<?php _e( 'Navigation options:', 'my-calendar' ); ?> <code>nav,jump,print,key,feeds,exports,none</code><?php mc_help_link( 'Help', __( 'My Calendar: Navigation Keywords', 'my-calendar' ), 3 ); ?>
		</span>
		</p>
