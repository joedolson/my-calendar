...
function my_calendar_menu() {
	...
	if ( function_exists( 'add_submenu_page' ) ) {
		...
		if ( 'true' === get_option( 'mc_remote' ) && function_exists( 'mc_remote_db' ) ) {
			...
			add_submenu_page( null, __( 'Add New Location', 'my-calendar' ), __( 'Add New Location', 'my-calendar' ), 'mc_edit_locations', 'my-calendar-locations', 'my_calendar_add_locations' );
